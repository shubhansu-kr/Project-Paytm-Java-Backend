...
class UserAccount {
    ...
    public void createAccount() throws Exception {
        ...
        String q2 = "insert into bank_user values('" + accno + "','" + name + "','" + addr + "','" + phno + "','" + aid
                + "','" + dob + "','" + email + "')";
        ...
        String q3 = "insert into bank_transaction values('" + tid + "','" + accno + "','" + damt + "','" + wamt + "','"
                + dt1 + "','" + balance + "')";
    ...
    void changepass() throws Exception {
        ...
        Connection con = c.fetchcon();
        Statement stmt = con.createStatement();
        String q1 = "update bank_authentication set password='" + npass + "' where userid='" + uid + "' and password='"
                + opass + "'";
