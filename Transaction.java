...
class Transaction {
    ...
    void deposit() throws Exception {
        ...
        String q1 = "select tid,balance from bank_transaction where accno='" + accno
                + "' and tid=(select max(tid) from bank_transaction where accno=" + accno + ")";
        ...
        String q2 = "insert into bank_transaction values('" + tid + "','" + accno + "','" + damt + "','" + wamt + "','"
                + dt + "','" + balance + "')";
